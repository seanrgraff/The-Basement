...
namespace Server.Misc
{
	...
	{
		private static int MaxAccountsPerIP = 20;
		...
		/* Old Haven/Magincia Locations
			...
			if ( Core.AOS )
			{
				...
				CityInfo britain = new CityInfo( "Britain", "Sweet Dreams Inn", 1496, 1628, 10 );
				StartingCities[StartingCities.Length - 1] = britain;
			}
		*/
