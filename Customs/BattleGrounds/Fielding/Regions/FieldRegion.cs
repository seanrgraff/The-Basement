...
{
    public class FieldRegion : BaseRegion
    {
        ...
        public override bool OnMoveInto(Mobile m, Direction d, Point3D newLocation, Point3D oldLocation)
        {
            ...
            if (!Field_Config.InAField((PlayerMobile)m))
                return false;
        ...
        public override bool AllowBeneficial(Mobile from, Mobile target)
        {
            ...
            { 
            	...
            	if (!Controller.Handeling.InField((PlayerMobile)from) || !Controller.Handeling.InField((PlayerMobile)target))
                return false;
            ...
            else if ( from is PlayerMobile && target is BaseCreature) 
            {
            	...
            	if (!Controller.Handeling.InField((PlayerMobile)from) || !Controller.Handeling.InField((PlayerMobile)targetPet.ControlMaster))
                	return false;
            ...
            else if ( from is BaseCreature && target is PlayerMobile) 
            {
            	...
            	if (!Controller.Handeling.InField((PlayerMobile)fromPet.ControlMaster) || !Controller.Handeling.InField((PlayerMobile)target))
                	return false;
            ...
            else if ( from is BaseCreature && target is BaseCreature) 
            {
            	...
            	if (!Controller.Handeling.InField((PlayerMobile)fromPet.ControlMaster) || !Controller.Handeling.InField((PlayerMobile)targetPet.ControlMaster))
                	return false;
