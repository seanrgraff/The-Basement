...
{
    public class FieldSetup_Rules_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
            ...
            AddLabel(266, 186, 70, @"View Field Rules");
            ...
            AddImage(225, 376, ImageID(Handeling.AllowTrees));
            AddLabel(245, 373, 54, @"Allow Trees");
            AddLabel(245, 393, 54, Handeling.NumberOfTrees.ToString() );
            
            AddImage(225, 410, ImageID(Handeling.AllowTraps));
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 1: // Spells
                    {
                        from.SendGump(new FieldSetup_Rules_Spells_View(Handeling, TeamID, Index));
                        break;
                    }
                case 2: // Combat Abilities
                    {
                        from.SendGump(new FieldSetup_Rules_Combat_View(Handeling, TeamID, Index));
                        break;
                    }
                case 3: // Skills
                    {
                        from.SendGump(new FieldSetup_Rules_Skills_View(Handeling, TeamID, Index));
                        break;
                    }
                case 4:  // Weapons
                    {
                        from.SendGump(new FieldSetup_Rules_Weapons_View(Handeling, TeamID, Index));
                        break;
                    }
                case 5: // Armor
                    {
                        from.SendGump(new FieldSetup_Rules_Armor_View(Handeling, TeamID, Index));
                        break;
                    }
                case 6: // Items
                    {
                        from.SendGump(new FieldSetup_Rules_Items_View(Handeling, TeamID, Index));
                        break;
                    }
                case 7: // Samurai
                    {
                        from.SendGump(new FieldSetup_Rules_Samurai_View(Handeling, TeamID, Index));
                        break;
                    }
                case 8: // Chivalry
                    {
                        from.SendGump(new FieldSetup_Rules_Chivalry_View(Handeling, TeamID, Index));
                        break;
                    }
                case 9: // Necromancy
                    {
                        from.SendGump(new FieldSetup_Rules_Necromancy_View(Handeling, TeamID, Index));
                        break;
                    }
                case 10: // Ninjitsu
                    {
                        from.SendGump(new FieldSetup_Rules_Ninjitsu_View(Handeling, TeamID, Index));
                        break;
                    }
                case 11: //Accepted
                    {
            ...
            if (info.ButtonID > 11)
            {
                ...
                from.SendGump(new FieldSetup_ViewParticipants(Handeling, TeamID, Index, teamid2));
            }
        }
    }

    public class FieldSetup_ViewParticipants : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;
        ...
        {
            Mobile from = sender.Mobile;
            from.SendGump(new FieldSetup_Rules_View(Handeling, TeamID, Index));
        }
    }

    public class FieldSetup_Rules_Armor_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Armor_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Combat_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Combat_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Items_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Items_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Skills_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Skills_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Weapons_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Weapons_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    //Spells Start Here ///////////////////////////////////////////////////////////////////////////////
    public class FieldSetup_Rules_Spells_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Spells_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 1: // First Circle
                    {
                        from.SendGump(new FieldSetup_Rules_Spells_1st_View(Handeling, TeamID, Index));
                        break;
                    }
                case 2: // Second Circle
                    {
                        from.SendGump(new FieldSetup_Rules_Spells_2nd_View(Handeling, TeamID, Index));
                        break;
                    }
                case 3: // Third Circle
                    {
                        from.SendGump(new FieldSetup_Rules_Spells_3rd_View(Handeling, TeamID, Index));
                        break;
                    }
                case 4: // Fourth Circle
                    {
                        from.SendGump(new FieldSetup_Rules_Spells_4th_View(Handeling, TeamID, Index));
                        break;
                    }
                case 5: // Fifth Circle
                    {
                        from.SendGump(new FieldSetup_Rules_Spells_5th_View(Handeling, TeamID, Index));
                        break;
                    }
                case 6: // Sixth Circle
                    {
                        from.SendGump(new FieldSetup_Rules_Spells_6th_View(Handeling, TeamID, Index));
                        break;
                    }
                case 7: // Seventh Circle
                    {
                        from.SendGump(new FieldSetup_Rules_Spells_7th_View(Handeling, TeamID, Index));
                        break;
                    }
                case 8: // Eigth Circle
                    {
                        from.SendGump(new FieldSetup_Rules_Spells_8th_View(Handeling, TeamID, Index));
                        break;
                    }
            }
        }
    ...
    public class FieldSetup_Rules_Spells_1st_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Spells_1st_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Spells_2nd_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Spells_2nd_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Spells_3rd_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Spells_3rd_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Spells_4th_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Spells_4th_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Spells_5th_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Spells_5th_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Spells_6th_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Spells_6th_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Spells_7th_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Spells_7th_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Spells_8th_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Spells_8th_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Samurai_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Samurai_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Chivalry_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Chivalry_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Ninjitsu_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Ninjitsu_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class FieldSetup_Rules_Necromancy_View : Gump
    {
        public Field Handeling;
        public int TeamID;
        public int Index;

        public FieldSetup_Rules_Necromancy_View(Field d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
