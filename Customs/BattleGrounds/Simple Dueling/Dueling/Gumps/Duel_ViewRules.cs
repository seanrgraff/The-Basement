...
{
    public class DuelSetup_Rules_View : Gump
    {
    ...
    public class DuelSetup_ViewParticipants : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
        ...
        {
            Mobile from = sender.Mobile;
            from.SendGump(new DuelSetup_Rules_View(Handeling, TeamID, Index));
        }
    }

    public class DuelSetup_Rules_Armor_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Combat_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Items_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Skills_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Weapons_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    //Spells Start Here ///////////////////////////////////////////////////////////////////////////////
    public class DuelSetup_Rules_Spells_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 1: // First Circle
                    {
                        from.SendGump(new DuelSetup_Rules_Spells_1st_View(Handeling, TeamID, Index));
                        break;
                    }
                case 2: // Second Circle
                    {
                        from.SendGump(new DuelSetup_Rules_Spells_2nd_View(Handeling, TeamID, Index));
                        break;
                    }
                case 3: // Third Circle
                    {
                        from.SendGump(new DuelSetup_Rules_Spells_3rd_View(Handeling, TeamID, Index));
                        break;
                    }
                case 4: // Fourth Circle
                    {
                        from.SendGump(new DuelSetup_Rules_Spells_4th_View(Handeling, TeamID, Index));
                        break;
                    }
                case 5: // Fifth Circle
                    {
                        from.SendGump(new DuelSetup_Rules_Spells_5th_View(Handeling, TeamID, Index));
                        break;
                    }
                case 6: // Sixth Circle
                    {
                        from.SendGump(new DuelSetup_Rules_Spells_6th_View(Handeling, TeamID, Index));
                        break;
                    }
                case 7: // Seventh Circle
                    {
                        from.SendGump(new DuelSetup_Rules_Spells_7th_View(Handeling, TeamID, Index));
                        break;
                    }
                case 8: // Eigth Circle
                    {
                        from.SendGump(new DuelSetup_Rules_Spells_8th_View(Handeling, TeamID, Index));
                        break;
                    }
            }
        }
    ...
    public class DuelSetup_Rules_Spells_1st_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Spells_2nd_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Spells_3rd_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Spells_4th_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Spells_5th_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Spells_6th_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Spells_7th_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Spells_8th_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Samurai_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;

        public DuelSetup_Rules_Samurai_View(Duel d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class DuelSetup_Rules_Chivalry_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;
    ...
    public class DuelSetup_Rules_Ninjitsu_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;

        public DuelSetup_Rules_Ninjitsu_View(Duel d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
    ...
    public class DuelSetup_Rules_Necromancy_View : Gump
    {
        public Duel Handeling;
        public int TeamID;
        public int Index;

        public DuelSetup_Rules_Necromancy_View(Duel d, int team, int id)
            : base(0, 0)
        {
            Handeling = d;
            TeamID = team;
