...
{
	public class RVSSetup_Rules_Spells : Gump
	{
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
            ...
            switch (info.ButtonID)
            {
                ...
                case 2: // First Circle
                    {
                        from.SendGump(new RVSSetup_Rules_Spells_1st(Handeling));
                        break;
                    }
                case 3: // Second Circle
                    {
                        from.SendGump(new RVSSetup_Rules_Spells_2nd(Handeling));
                        break;
                    }
                case 4: // Third Circle
                    {
                        from.SendGump(new RVSSetup_Rules_Spells_3rd(Handeling));
                        break;
                    }
                case 5: // Fourth Circle
                    {
                        from.SendGump(new RVSSetup_Rules_Spells_4th(Handeling));
                        break;
                    }
                case 6: // Fifth Circle
                    {
                        from.SendGump(new RVSSetup_Rules_Spells_5th(Handeling));
                        break;
                    }
                case 7: // Sixth Circle
                    {
                        from.SendGump(new RVSSetup_Rules_Spells_6th(Handeling));
                        break;
                    }
                case 8: // Seventh Circle
                    {
                        from.SendGump(new RVSSetup_Rules_Spells_7th(Handeling));
                        break;
                    }
                case 9: // Eigth Circle
                    {
                        from.SendGump(new RVSSetup_Rules_Spells_8th(Handeling));
                        break;
                    }
            }
		}
    ...
    public class RVSSetup_Rules_Spells_1st : Gump
    {
        public RVS Handeling;

        public RVSSetup_Rules_Spells_1st(RVS d)
            : base(0, 0)
        {
            Handeling = d;
    ...
    public class RVSSetup_Rules_Spells_2nd : Gump
    {
        public RVS Handeling;

        public RVSSetup_Rules_Spells_2nd(RVS d)
            : base(0, 0)
        {
            Handeling = d;
    ...
    public class RVSSetup_Rules_Spells_3rd : Gump
    {
        public RVS Handeling;

        public RVSSetup_Rules_Spells_3rd(RVS d)
            : base(0, 0)
        {
            Handeling = d;
    ...
    public class RVSSetup_Rules_Spells_4th : Gump
    {
        public RVS Handeling;

        public RVSSetup_Rules_Spells_4th(RVS d)
            : base(0, 0)
        {
            Handeling = d;
    ...
    public class RVSSetup_Rules_Spells_5th : Gump
    {
        public RVS Handeling;
    ...
    public class RVSSetup_Rules_Spells_6th : Gump
    {
        public RVS Handeling;
    ...
    public class RVSSetup_Rules_Spells_7th : Gump
    {
        public RVS Handeling;
    ...
    public class RVSSetup_Rules_Spells_8th : Gump
    {
        public RVS Handeling;
    ...
    public class RVSSetup_Rules_Samurai : Gump
    {
        public RVS Handeling;
    ...
    public class RVSSetup_Rules_Chivalry : Gump
    {
        public RVS Handeling;
    ...
    public class RVSSetup_Rules_Ninjitsu : Gump
    {
        public RVS Handeling;
    ...
    public class RVSSetup_Rules_Necromancy : Gump
    {
        public RVS Handeling;
