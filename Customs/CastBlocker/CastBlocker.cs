...
{
	public class CastBlocker : Item
	{
		public static void Initialize()
		{
			TileData.ItemTable[0x2199].Flags = TileFlag.Impassable | TileFlag.NoShoot;
			TileData.ItemTable[0x2199].Height = 20;
		}

		public override string DefaultName
		{
			get { return "no line of sight for casting"; }
		}

		[Constructable]
		public CastBlocker() : base( 0x2199 )
		{
			Movable = false;
		}

        public CastBlocker(Serial serial)
            : base(serial)
		{
		}
