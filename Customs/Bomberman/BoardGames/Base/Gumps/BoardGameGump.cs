...
namespace Server.Gumps
{
	...
	public class BoardGameGump : Gump
	{
		...
		protected BoardGameControlItem _ControlItem = null;
		protected String _GameName = null;
		protected Mobile _Owner = null;
		...
		public BoardGameGump( Mobile owner, String gameName ) : base( 50, 50 )
		{
			_Owner = owner;
			_GameName = gameName;
