...
namespace Server.Gumps
{
	public class ConfirmResetGameScoreGump : BoardGameGump
	{
		...
		//public ConfirmResetGameScoreGump( Mobile owner, String gameName ) : base( owner, gameName )
		//{
		//	AddLabel( 40, 20, 1152, "Game:" );
		//	
		//	AddLabel( 140, 20, 1172, gameName );
		//	
		//	AddHtml( 40, 50, Width - 80, 80, "You are about to reset all the score data for " + gameName + ".  Once you do this, it cannot be undone.  Are you sure you wish to do this?", true, false );
		//	
		//	AddButton( 30, 160, 0xF7, 0xF8, 1, GumpButtonType.Reply, 0 );
		//	
		//	AddButton( 160, 160, 0xF1, 0xF2, 0, GumpButtonType.Reply, 0 );
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			if( info.ButtonID == 1 )
			{
				...
				{
					BoardGameData.ResetScores( _GameName );
				}
