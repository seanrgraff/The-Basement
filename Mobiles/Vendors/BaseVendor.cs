...
namespace Server.Mobiles
{
	...
	public abstract class BaseVendor : BaseCreature, IVendor
	{
		...
		public BaseVendor( string title ) : base( AIType.AI_Melee, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			LoadSBInfo();
		...
		public BaseVendor( string title, AIType ai ) : base( ai, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			LoadSBInfo();
		...
		{
			get{ return OppositionGroup.BaseVendorAndAll; }
		}
